...
#pragma mark - 初始化界面
- (void)initUI {
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(dismiss) name:@"XKCommonAlertViewDismiss" object:nil];
    XKWeakSelf(ws);
...
+ (void)dismissAll {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"XKCommonAlertViewDismiss" object:nil];
}
